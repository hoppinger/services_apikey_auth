...
namespace Drupal\services_apikey_auth\Form;
...
class ApiKeyForm extends EntityForm {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['id'] = array(
      ...
      '#machine_name' => array(
        'exists' => '\Drupal\services_apikey_auth\Entity\ApiKey::load',
      ),
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    switch ($status) {
      ...
      default:
		...
		// Please confirm that `$api_key` is an instance of `Drupal\Core\Entity\EntityInterface`. Only the method name and not the class name was checked for this replacement, so this may be a false positive.
